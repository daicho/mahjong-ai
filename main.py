...
yakus = {
    ...
    mj.Yaku.TANYAO:    (1, 1, False),  # タンヤオ
    mj.Yaku.YAKUHAI:   (1, 1, False),  # 役牌
    mj.Yaku.HAITEI:    (1, 1, False),  # 海底摸月
    mj.Yaku.HOTEI:     (1, 1, False),  # 河底撈魚
